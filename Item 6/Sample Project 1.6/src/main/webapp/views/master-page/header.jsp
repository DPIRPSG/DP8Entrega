...
<div>
	<security:authorize access="isAuthenticated()">
		<script>document.write('<a href="https://' + window.location.hostname + ':443" ><img src="images/logo.png" alt="Sample Project 1.6 Co., Inc." /></a>');</script>
	</security:authorize>
	<security:authorize access="isAnonymous()">
		<script>document.write('<a href="http://' + window.location.hostname + ':80" ><img src="images/logo.png" alt="Sample Project 1.6 Co., Inc." /></a>');</script>
	</security:authorize>
</div>
		...
		<security:authorize access="isAuthenticated()">
			<li>
				...
				<ul>
					...
					<li><b> <script>document.write('<a href="http://' + window.location.hostname + ':80/j_spring_security_logout" >');</script> <spring:message code="master.page.logout" /></a></b></li>
				</ul>
			</li>
		</security:authorize>
	</ul>
